...
public class LancamentoResource {
	...
	@ExceptionHandler({NoSuchElementException.class, PessoaInativaException.class})
	protected ResponseEntity<Object> handlePessoaInativaOuInexistenteException(Exception ex){
